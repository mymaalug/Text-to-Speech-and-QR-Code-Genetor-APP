...
import qr_code_gui as graphics
import generate_qr_code


# This is generic function which display the generated QR code on the window
def displayImage():
...
# The function for changing the color of QR codes take the color in name e.g. 'Black'
